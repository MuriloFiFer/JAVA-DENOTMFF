...
public class Operadores {
    ...
    public void relacionais() {
        ...
        int primeiraVariavel = 3;
        int segundaVariavel = 2;
        System.out.println("O valor da primeira variável é "
                + primeiraVariavel + " e o da segunda é "
                + segundaVariavel + ".");
        boolean primeiraVariavelEMaiorQueASegunda = primeiraVariavel > segundaVariavel; // boolean variavel Verdadeiro
                                                                                        // ou Falso
    ...
    public void operadoresLogicos() {
        ...
        System.out.println("===============================");
        boolean aplicarDesconto = usuarioVIP && compraComValorAlto; //Operador lógico E (necessida os 2 valores true)
